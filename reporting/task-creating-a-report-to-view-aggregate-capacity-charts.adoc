...
. 在Excel中開啟下載的檔案。
. 如有需要、請按一下*啟用編輯*。
. 在上 `data` 工作表、請在上按一下滑鼠右鍵 `Type` 列並選擇* Sort*>* Sorting A to Z*。
+
image::../media/sort-01.png[排序01]
...
+
image::../media/threed-column-01.png[第01欄]
...
+
image::../media/total-vs-available-capacity.png[總容量與可用容量]
