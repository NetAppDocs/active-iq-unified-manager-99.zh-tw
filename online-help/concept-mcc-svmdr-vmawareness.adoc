...
* HA配對和vCenter Server的主要和次要叢集必須由Unified Manager管理。如需MetroCluster 有關支援的資訊、請參閱
+
xref:concept-managing-and-monitoring-metrocluster-configurations.adoc[管理及監控MetroCluster 功能]
